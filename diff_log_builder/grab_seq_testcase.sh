...
psql -p 5432 -h 127.0.0.1 npm_data -c "SELECT raw_json FROM change_log where seq = $seq;" -t -A -o $SCRIPT_DIR/resources/test_deserialize_change/input/seq_$seq.json.tmp
