...
const BIG_CHANGE_JSON_STR: &'static str = include_str!("../resources/test_changes/input/seq_832853_cleaned.json");
const SMALL_CHANGE_JSON_STR: &'static str = include_str!("../resources/test_changes/input/seq_1166950.json");
